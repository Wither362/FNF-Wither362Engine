...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		scoreText = if(ClientPrefs.badWords) new FlxText(10, 10, 0, "FUCKING SCORE: 49324858", 36) else new FlxText(10, 10, 0, "SCORE: 49324858", 36);
	...
	override function update(elapsed:Float)
	{
		...
		scoreText.text = if(ClientPrefs.badWords) "FUCKING WEEK SCORE:" + lerpScore else "WEEK SCORE:" + lerpScore;
